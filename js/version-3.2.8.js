...
function eee(){
	$('.gift-item1').animate({"top":-11.78+"rem"},600,function(){
		$(".alert").hide();
		//console.log(1)
	})
	$('.gift-item2').animate({"top":-11.78+"rem"},600,function(){
		$(".alert").hide();
		//console.log(1)
	})
}
...
$(".home span").on("touchstart",function(even){
	...
	if(m==1){
		 $('.alert').show();
    	$('.gift-item2').animate({"top":0+"rem"},600);
	}
	else{
		$('.alert').show();
    	$('.gift-item1').animate({"top":0+"rem"},600);
	}
